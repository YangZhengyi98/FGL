...
#    @typeassert(train_matrix=csr_matrix, test_matrix=csr_matrix)
    def __init__(self, train_matrix, test_matrix, negative_matrix):
        super(ProxyEvaluator, self).__init__()

        user_pos_train = train_matrix
        user_pos_test = test_matrix
        user_neg_test = None

        self.evaluator = FoldOutEvaluator(user_pos_train, user_pos_test, user_neg_test)
...
class FoldOutEvaluator(AbstractEvaluator):
    ...
    def __init__(self, user_pos_train, user_pos_test, user_neg_test):
        super(FoldOutEvaluator, self).__init__()
        top_k = [20, 100, 200, 500]
        self.batch_size = 64
